...
import { Shield, Lock, Activity, Radio, TrendingUp, Zap, Signal, Users, Target, Settings } from "lucide-react";

export default function PulseLandingPage() {
  return (
    <main className="relative w-screen h-screen bg-[#000005] text-white flex flex-col justify-between overflow-hidden font-mono">
      
      {/* 1. ENVIRONNEMENT (Grille et Scanlines) */}
      ...
      <div className="absolute inset-0 z-20 pointer-events-none p-10 flex justify-between items-center opacity-80">
        <div className="space-y-6">
          ...
          <div className="border-l-2 border-violet-800/50 pl-4 bg-black/20 p-4">
            <div className="text-[10px] text-gray-500 font-black tracking-widest uppercase">Nodes: 8 / 8</div>
            <div className="text-[10px] text-gray-500 font-black tracking-widest uppercase">Lat: 14ms</div>
          </div>
        </div>
      ...
      {/* 4. CENTRE : LOGO ET ORB (Rééquilibré) */}
      <div className="flex-1 flex flex-col items-center justify-center relative z-30">
        <div className="relative w-[600px] h-[600px] flex items-center justify-center">
          {/* L'ORB CALMÉ */}
          <div className="energy-core" />
          <div className="core-ring" />
          <div className="core-ring" style={{ animationDuration: '30s', animationDirection: 'reverse', opacity: 0.3 }} />
          ...
          <div className="relative text-center select-none z-10">
            ...
            <div className="flex gap-6 mt-16 justify-center pointer-events-auto">
              <Link href="/terminal" className="px-14 py-4 bg-violet-600/20 border-2 border-violet-500 text-white font-black uppercase text-[10px] tracking-[0.4em] rounded-full hover:bg-violet-600 transition-all shadow-[0_0_50px_rgba(124,58,237,0.4)] active:scale-95">
                WATCHER
              </Link>
      ...
      {/* 5. FOOTER AVEC TICKER DYNAMIQUE */}
